...
export const SummaryCards: React.FC<SummaryCardsProps> = ({ summary }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      {/* Card Entrada - VOLTANDO PARA VERDE conforme solicitado */}
      <div className="relative overflow-hidden bg-gradient-to-br from-emerald-400 to-teal-600 p-6 rounded-3xl shadow-lg shadow-emerald-100 text-white transition-transform hover:scale-[1.02]">
        <div className="absolute top-0 right-0 -mr-8 -mt-8 w-32 h-32 rounded-full bg-white opacity-20 blur-xl"></div>
        <div className="flex items-center justify-between relative z-10">
          <div>
            <p className="text-emerald-50 font-bold text-sm mb-1 uppercase tracking-wide opacity-90">Entradas</p>
